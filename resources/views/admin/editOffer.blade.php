                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            <input type="text" name="name" id="name_ar"
                                                ...
                                                areia-describedby="helper" value="{{ $offer->name }}">
                                            @error('name')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="text" name="place" id="description_ar"
                                                ...
                                                areia-describedby="helper" value="{{ $offer->place }}">
                                            @error('place')
                                                <div class="alert alert-danger mt-3">{{ $message }}</div>
                                            @enderror
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="text" name="discription" id="description_ar"
                                                ...
                                                areia-describedby="helper" value="{{ $offer->discription }}">
                                            @error('discription')
                                                <div class="alert alert-danger mt-3">{{ $message }}</div>
                                            @enderror
                                            <div class="input-group-append">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-lg">
                                            ...
                                            <input type="text" name="price" id="description_ar"
                                                ...
                                                areia-describedby="helper" value="{{ $offer->price }}">
                                            @error('price')
                                                <div class="alert alert-danger mt-3">{{ $message }}</div>
                                            @enderror
                                            <div class="input-group-append">
